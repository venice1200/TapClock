/*
    ...
    v0.8.3
    Added:   Battery Alarm; batteryWarning & batteryCritical, blinking, buzzer etc.
...
// **************************************************************
  ...
  digitalWrite(LEDL, LEDL_VAR || ((RTCAlarm || batteryAlarmWarning || batteryAlarmCritical) && alarmBlink));
  ...
  if ( ((State == 61) && usbConnected) || RTCAlarm) {
